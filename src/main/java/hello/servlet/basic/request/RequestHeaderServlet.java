...
public class RequestHeaderServlet extends HttpServlet {
    ...
    private void printStartLine(HttpServletRequest request) { // ctrl+shift+alt+t -> 단축키 하고 메서드 추출
        ...
        System.out.println("request.isSecure() = " + request.isSecure()); //http 사용 유무 -> false
...
//        request.getHeader("host"); 하나만 조회하고 싶을 때
    ...
    private void printEtc(HttpServletRequest request) {
        ...
        // 로컬에서 테스트하면 Ipv6 정보가 나오는 데, Ipv4 정보를 보고 싶으면 다음 옵션을 VM options에 넣어주면 된다.
        // -Djava.net.preferIpv4Stack=true
        // 지금까지 HttpServletRequest를 통해서 HTTP 메시지의 start-line,header 정보 조회 방법을 이해했다.
        // 이제 본격적으로  HTTP 요청 데이터를 어떻게 조회하는 지 알아보자.
